...
Another obstruction for the flatness comes from \cite[26.2.11]{FOAG}.
\end{answer}
...
$$\Omega_{E/S} \cong \pi^* e^* \Omega_{E/S} = \pi^* \omega_{E/S} \cong \pi^* \pi_* \Omega_{E/S}.$$
\end{itemize}
\end{remark}
