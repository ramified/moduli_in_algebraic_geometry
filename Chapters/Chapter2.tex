...
\begin{eg}[Moduli of line bundle with base-point-free sections is represented by $\mathbb{P}_{\kappa}^n$]
...
\begin{eg}[{Moduli of lines through the origin in $\mathbb{A}_{\kappa}^{n+1}$ is represented by $\mathbb{P}_{\kappa}^n$}]
