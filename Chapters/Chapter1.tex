...
We need to define stack, algebraic stack, Deligne-Munford stack and some related concepts. Maybe I can follow \cite{alper2021introduction}. It seems like so nicely written.
\begin{remark}
