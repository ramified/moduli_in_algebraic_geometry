...
\item Verify the semistability of $V_\mu$ by induction. Shows that
$$
\dim \Hom (F_{r_1}, F_{r_2}) =\dim \Ext (F_{r_2}, F_{r_1}) =1.
$$
Describe $H^{\bullet}(F_r)$. If you are clever and hardworking, compute $\Hom (F_r, V_\mu)$ and $\Hom (V_\mu, F_r)$.
