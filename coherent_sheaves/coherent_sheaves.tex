...
$$\Phi_K \circ \Phi_{K^{-1}[g]} \cong \Id_{D^b(B)}$$
...
$$\widetilde{SL}_2(\mathbb{Z})= \left< \widetilde{S},\widetilde{T},c\;\textcolor{gray}{ =[-1]}  \;\middle|\; \widetilde{S}^4=2g \cdot c,\;\; \left(\widetilde{T}\widetilde{S}\right)^3=\left(\rule{0mm}{3mm}i(\mathcal{L})+n\right)c \right> $$
